 ...
 * @author majingze
 */
public class LightingProgressbar extends View implements Runnable {
    ...
    public LightingProgressbar(Context context) {
        this(context, null, 0);
    }

    public LightingProgressbar(Context context, AttributeSet attrs) {
    ...
    private void initAttrs(AttributeSet attrs) {
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.LightingProgressbar);
        try {
            textSize = (int) ta.getDimension(R.styleable.LightingProgressbar_textSize, 12);
            loadingColor = ta.getColor(R.styleable.LightingProgressbar_loadingColor, Color.parseColor("#40c4ff"));
            stopColor = ta.getColor(R.styleable.LightingProgressbar_stopColor, Color.parseColor("#ff9800"));
            radius = (int) ta.getDimension(R.styleable.LightingProgressbar_radius, 0);
            borderWidth = (int) ta.getDimension(R.styleable.LightingProgressbar_borderWidth, 1);
        } finally {
            ta.recycle();
        }
    }
